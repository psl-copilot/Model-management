 ...
 */
export const RequireClaims = (...claims: string[]): MethodDecorator =>
 ...
 */
export const RequireAnyClaims = (...claims: string[]): MethodDecorator =>
 ...
 */
export const RequireClaim = (claim: string): MethodDecorator =>
